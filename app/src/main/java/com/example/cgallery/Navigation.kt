...
sealed interface GalleryKey : NavKey {
    ...
    @Serializable data class CoverPicker(val bucketName: String? = null, val groupId: Long? = null, val isFavourites: Boolean = false) : GalleryKey
