...
sealed interface GalleryKey : NavKey {
    ...
    @Serializable data class Viewer(val startIndex: Int, val albumId: String? = null, val isFavourites: Boolean = false, val isSearch: Boolean = false) : GalleryKey
